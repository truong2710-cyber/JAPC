...
def cfg():
    ...
    use_wce = True
    use_bound = False
    bound_wt = 0 # weight for boundary loss
    ...
    clsname = "grid_proto" # 
    reload_model_path = 'runs/mySSL__CURVAS_Superpix_sets_1_1shot/36/snapshots/25000.pth' # path for reloading a trained model (overrides ms-coco initialization)
